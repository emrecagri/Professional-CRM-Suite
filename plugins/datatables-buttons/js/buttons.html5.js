	...
	action: function ( e, dt, button, config ) {
		...
		if ( document.queryCommandSupported('copy') ) {
			...
			try {
				...
				if (successful) {
					dt.buttons.info(
						dt.i18n( 'buttons.copyTitle', 'Kopyalandı' ),
						dt.i18n( 'buttons.copySuccess', {
							1: 'Tablodaki 1 satır kopyalandı',
							_: 'Tablodaki %d satır kopyalandı'
						}, exportData.rows ),
						2000
					);
		...
		dt.buttons.info( dt.i18n( 'buttons.copyTitle', 'Kopyalandı' ), message, 0 );
